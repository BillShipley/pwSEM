...
```
# Introduction
The pwSEM package contains functions for conducting piecewise structural equation modelling (SEM).  There are six main functions that users will typically use.Only pwSEM() is required unless you want to conduct each of the steps in the dsep test yourself and then separately estimate the free parameters of the structural equations.
...
## The vMCX2 function to better estimate the null probability of the maximum likelihood chi-squared statistic in covariance-based SEM with small sample sizes
