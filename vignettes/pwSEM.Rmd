...
*constrained.edges*: a character object specifying which pairs of variables have a priori known edges in the partially oriented dependency graph:  constrained.edges="X2|X1" means that you know that there cannot be an edge between X1 and X2 in this graph, "X2->X1" means that X2 is a direct cause of X1 and "X2<->X1" means that neither X1 nor X2 cause the other, but both share a common latent direct cause.  For more than constrained edge, insert a RETURN after each pair in the character object.  The default is constrained.edges=NA, meaning that no edges are constrained by a priori knowledge.
...
If you wanted to forbid edges between XF and XM (XF|XM) and force XH to directly cause XR, you would do this:
