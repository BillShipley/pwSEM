...
The pwSEM package contains functions for conducting piecewise structural equation modelling (SEM).  There are eight  functions.  Each of them are described in this vignette.
...
This  is only needed if you must do an inferential test of a piecewise SEM in separate steps rather than using the pwSEM() function.  This function takes, as input, a DAG including marginalized and/or conditioned latents and outputs the d-separation equivalent DAG involving only the observed variables in the full DAG.
...
This  is only needed if you must do an inferential test of a piecewise SEM in separate steps rather than using the pwSEM() function.  This function takes, as input, a MAG including marginalized and/or conditioned latents and outputs the equivalent DAG including the latent  variables.
